...
import { TwitterIntegration } from "@pumpit/social-integrations"
...
export async function POST(request: NextRequest) {
  try {
    ...
    const twitterIntegration = new TwitterIntegration(process.env.TWITTER_BEARER_TOKEN!)

    // Verify the post
    const verificationResult = await twitterIntegration.verifyPost(
      postUrl,
